    ...
    return(
      <div className='item'>
        ...
        <button
          ...
          ref="copy"
          data-clipboard-text={this.props.shortUrl}>{this.state.justCopied ? 'Copied' :'Copy'}
        </button>
        <button
          className='button button--pill'
          onClick={()=>{
...
lastVisitedAt: PropTypes.number  // Can't use isRequired due to initial seed nulls
  }
